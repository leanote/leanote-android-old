 ...
 */
public class LeaImageGetter implements Html.ImageGetter {
    ...
    public LeaImageGetter(TextView view) {
        this(view, 0);
    }

    public LeaImageGetter(TextView view, int maxSize) {
        mWeakView = new WeakReference<TextView>(view);
        mMaxSize = maxSize;
    }

    public LeaImageGetter(TextView view, int maxSize, ImageLoader imageLoader, Drawable loadingDrawable,
